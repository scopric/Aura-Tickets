    ...
    try {
      ...
      if (error) {
        if (error.message?.includes('unique')) {
          toast.success('Voce ja esta inscrito!')
        } else {
          throw error
        }
      } else {
      ...
      toast.error('Erro ao salvar inscricao. Tente novamente.')
    } finally {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8">
            ...
            <div>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  { label: 'Eventos', href: '/event/festival-de-verao-2025' },
          ...
          <div className="lg:col-span-4">
            ...
            <form onSubmit={handleSubscribe} className="relative">
              ...
              >
                {isSubmitting ? <Loader2 className="w-3 h-3 animate-spin" /> : subscribed ? 'Enviado!' : 'Assinar'}
              </button>
            </form>
          </div>
        </div>

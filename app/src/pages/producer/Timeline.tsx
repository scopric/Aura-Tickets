  ...
  if (isLoading) {
    return (
      <div className="p-6 lg:p-10 max-w-4xl mx-auto flex flex-col items-center justify-center py-20">
        ...
        <p className="text-espresso/60 text-sm">Carregando cronograma...</p>
      </div>
    )
  }
    ...
    <div className="p-6 lg:p-10 max-w-4xl mx-auto">
      ...
      {selectedEventId ? (
        <div className="relative">
                ...
                <div key={item.id} className="relative flex items-start gap-4 py-4 group">
                  ...
                  <div className={`flex-1 p-4 rounded-2xl border transition-all ${
                    ...
                    <div className="flex items-start justify-between">
                      ...
                      <button onClick={() => handleDelete(item)} className="p-1.5 rounded-lg hover:bg-red-50 text-espresso/10 hover:text-red-400 transition-colors opacity-0 group-hover:opacity-100">
          ...
          {items.length === 0 && (
            <div className="text-center py-16">
              ...
              <p className="text-sm text-espresso/30">Nenhum item no cronograma.</p>
              <p className="text-xs text-espresso/20 mt-1">Adicione o primeiro item da linha do tempo.</p>
            </div>
          )}
        </div>
      ) : (
        <div className="text-center py-16">
          ...
          <p className="text-sm text-espresso/30">Selecione um evento para ver o cronograma.</p>
        </div>
      )}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-md bg-white/80 backdrop-blur-xl border border-white/60 rounded-3xl p-6 shadow-elevated">
            ...
            <div className="space-y-3">
              ...
              <select value={form.type} onChange={e => setForm({ ...form, type: e.target.value as DbTimelineItem['type'] })} className="w-full px-4 py-2.5 bg-white/60 border border-white/60 rounded-xl text-sm text-espresso/60 focus:outline-none">
